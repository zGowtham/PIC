...
main@k:	; 2 bytes @ 0xA
	ds	2
	global	main@value1
main@value1:	; 2 bytes @ 0xC
	ds	2
	global	main@value2
main@value2:	; 2 bytes @ 0xE
	ds	2
	global	main@value3
main@value3:	; 2 bytes @ 0x10
	ds	2
	global	main@value
main@value:	; 2 bytes @ 0x12
	ds	2
	global	main@m
main@m:	; 2 bytes @ 0x14
	ds	2
...
;                                    2 COMMO    1
;              _pulse
;  _eeprom_write                                      2    1   32   0.00
;                                    0 COMMO    3
;  _command                                           1    0   17   0.00
;                                    2 COMMO    1
;              _pulse
;  _eeprom_read                                       4    0   24   0.00
;                                    0 COMMO    4
;    _pulse                                           0    0    1   0.00
;              _delay
;      _delay                                         0    2    1   0.00
...
; *************** function _main *****************
; Defined at:
;		line 39 in file "C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM LCD\EEPROM LCD.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;  m               2   20[BANK0 ] int 
;  value           2   18[BANK0 ] int 
;  value3          2   16[BANK0 ] int 
;  value2          2   14[BANK0 ] int 
;  value1          2   12[BANK0 ] int 
;  x               2    8[BANK0 ] int 
;  k               2   10[BANK0 ] int 
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM LCD\EEPROM LCD.c"
	line	39
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;EEPROM LCD.c: 38: void main()
;EEPROM LCD.c: 39: {
...
l30000786:	
;EEPROM LCD.c: 40: TRISD=0X00; PORTD=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(8)	;volatile
	line	41
;EEPROM LCD.c: 41: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(9)	;volatile
	line	42
;EEPROM LCD.c: 42: ANSEL=0x00; ANSELH=0x00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000787:	
	line	44
;EEPROM LCD.c: 44: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000788:	
	line	45
;EEPROM LCD.c: 45: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30000789:	
	line	47
;EEPROM LCD.c: 47: command(0X01);
	movlw	(01h)
	fcall	_command
...
l30000794:	
	line	57
;EEPROM LCD.c: 57: value = eeprom_read(11);
	movlw	(0Bh)
	fcall	_eeprom_read
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l30000795:	
	line	58
;EEPROM LCD.c: 58: value1 = eeprom_read(12);
	movlw	(0Ch)
	fcall	_eeprom_read
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l30000796:	
	line	59
;EEPROM LCD.c: 59: value2 = eeprom_read(13);
	movlw	(0Dh)
	fcall	_eeprom_read
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l30000797:	
	line	60
;EEPROM LCD.c: 60: value3 = eeprom_read(14);
	movlw	(0Eh)
	fcall	_eeprom_read
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l30000798:	
	line	62
;EEPROM LCD.c: 62: x=value+value1+value2+value3;
	movf	(main@value1),w
	addwf	(main@value),w
	movwf	(??_main+0+0)
	movf	(main@value1+1),w
	skipnc
	incf	(main@value1+1),w
	addwf	(main@value+1),w
	movwf	1+(??_main+0+0)
	movf	(main@value2),w
	addwf	0+(??_main+0+0),w
	movwf	(??_main+2+0)
	movf	(main@value2+1),w
	skipnc
	incf	(main@value2+1),w
	addwf	1+(??_main+0+0),w
	movwf	1+(??_main+2+0)
	movf	(main@value3),w
	addwf	0+(??_main+2+0),w
	movwf	(main@x)
	movf	(main@value3+1),w
	skipnc
	incf	(main@value3+1),w
	addwf	1+(??_main+2+0),w
	movwf	1+(main@x)
...
l30000799:	
	line	69
;EEPROM LCD.c: 66: {
;EEPROM LCD.c: 69: for(i=x;i<1000;i++)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@x+1),w
	clrf	(_i+1)
...
l30000802:	
	line	76
;EEPROM LCD.c: 76: eeprom_write(11,k);
	movf	(main@k),w
	movwf	(?_eeprom_write)
	movlw	(0Bh)
	fcall	_eeprom_write
...
l30000803:	
	line	80
;EEPROM LCD.c: 77: }
;EEPROM LCD.c: 80: if(i>255&&i<511)
	movf	(_i+1),w
	xorlw	80h
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l30000806:	
	line	84
;EEPROM LCD.c: 84: eeprom_write(12,m);
	movf	(main@m),w
	movwf	(?_eeprom_write)
	movlw	(0Ch)
	fcall	_eeprom_write
...
l30000807:	
	line	88
;EEPROM LCD.c: 85: }
;EEPROM LCD.c: 88: if(i>510&&i<766)
	movf	(_i+1),w
	xorlw	80h
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
l30000810:	
	line	92
;EEPROM LCD.c: 92: eeprom_write(13,m);
	movf	(main@m),w
	movwf	(?_eeprom_write)
	movlw	(0Dh)
	fcall	_eeprom_write
...
l30000813:	
	line	100
;EEPROM LCD.c: 100: eeprom_write(14,m);
	movf	(main@m),w
	movwf	(?_eeprom_write)
	movlw	(0Eh)
	fcall	_eeprom_write
...
l30000820:	
	line	114
;EEPROM LCD.c: 114: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000821:	
	line	115
;EEPROM LCD.c: 115: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
...
l30000827:	
	line	125
;EEPROM LCD.c: 125: eeprom_write(11,i);
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000828:	
	line	126
;EEPROM LCD.c: 126: eeprom_write(12,i);
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000829:	
	line	127
;EEPROM LCD.c: 127: eeprom_write(13,i);
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000830:	
	line	128
;EEPROM LCD.c: 128: eeprom_write(14,i);
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l17:	
	line	131
;EEPROM LCD.c: 129: }
;EEPROM LCD.c: 131: _delay((unsigned long)((100)*(4000000/4000.0)));
	movlw	130
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
movwf	(??_main+0+0+1),f
...
; *************** function _data *****************
; Defined at:
;		line 31 in file "C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM LCD\EEPROM LCD.c"
; Parameters:    Size  Location     Type
...
;EEPROM LCD.c: 30: void data(char data)
;EEPROM LCD.c: 31: {
...
l30000761:	
	line	33
;EEPROM LCD.c: 33: PORTD=data;
	movf	(data@data),w
	movwf	(8)	;volatile
	
l30000762:	
	line	34
;EEPROM LCD.c: 34: pulse();
	fcall	_pulse
...
; Defined at:
;		line 8 in file "C:\Program Files (x86)\HI-TECH Software\PICC\9.70\sources\eewrite.c"
; Parameters:    Size  Location     Type
...
; 
psect	text64
	file	"C:\Program Files (x86)\HI-TECH Software\PICC\9.70\sources\eewrite.c"
	line	8
...
; *************** function _command *****************
; Defined at:
;		line 24 in file "C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM LCD\EEPROM LCD.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;EEPROM LCD.c: 23: void command(char data)
;EEPROM LCD.c: 24: {
...
l30000774:	
	line	26
;EEPROM LCD.c: 26: PORTD=data;
	movf	(command@data),w
	movwf	(8)	;volatile
	
l30000775:	
	line	27
;EEPROM LCD.c: 27: pulse();
	fcall	_pulse
...
; 
psect	text66
	file	"C:\Program Files (x86)\HI-TECH Software\PICC\9.70\sources\eeread.c"
	line	8
...
; *************** function _pulse *****************
; Defined at:
;		line 16 in file "C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM LCD\EEPROM LCD.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000778:	
	line	19
;EEPROM LCD.c: 19: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	20
;EEPROM LCD.c: 20: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 11 in file "C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM LCD\EEPROM LCD.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
...
;EEPROM LCD.c: 10: void delay(int x)
;EEPROM LCD.c: 11: {
