...
z	equ	0
pclath	equ	10
;COMMON:	_main->_eeprom_read
;COMMON:	_main->_eeprom_write
;BANK0:	_main->__delay
...
__pidataBANK0:
	file	"C:\Program Files (x86)\HI-TECH Software\PICC\9.70\sources\EEPROM.c"
	line	10
...
__delay$0:	; 4 bytes @ 0x0
	ds	4
	global	main@number
main@number:	; 10 bytes @ 0x4
	ds	10
	global	main@j
main@j:	; 2 bytes @ 0xE
	ds	2
	global	main@value
main@value:	; 2 bytes @ 0x10
	ds	2
	global	main@i
main@i:	; 2 bytes @ 0x12
	ds	2
...
; *************** function _main *****************
; Defined at:
;		line 5 in file "C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;  number         10    4[BANK0 ] unsigned char [10]
;  i               2   18[BANK0 ] int 
;  value           2   16[BANK0 ] int 
;  j               2   14[BANK0 ] int 
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\EEPROM\EEPROM.c"
	line	5
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;EEPROM.c: 4: void main()
;EEPROM.c: 5: {
...
l30000553:	
;EEPROM.c: 6: TRISA=0X00; PORTA=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000554:	
	line	10
;EEPROM.c: 9: int i,j;
;EEPROM.c: 10: char number[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
...
l30000556:	
	line	12
;EEPROM.c: 12: value = eeprom_read(11);
	movlw	(0Bh)
	fcall	_eeprom_read
	movwf	(??_main+0+0)
	clrf	(??_main+0+0+1)
...
l30000557:	
	line	16
;EEPROM.c: 15: {
;EEPROM.c: 16: for(i=value;i<10;i++)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@value+1),w
	clrf	(main@i+1)
...
l30000564:	
	line	24
;EEPROM.c: 24: eeprom_write(11,value);
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000568:	
	line	29
;EEPROM.c: 28: {
;EEPROM.c: 29: _delay((unsigned long)((100)*(4000000/4000.0)));
	movlw	130
movwf	(??_main+0+0+1),f
	movlw	221
movwf	(??_main+0+0),f
