...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Multiplication\Multiplication.c"
	line	27
...
main@number:	; 10 bytes @ 0x12
	ds	10
;Data sizes: Strings 0, constant 0, data 20, bss 12, persistent 0 stack 0
...
; *************** function _main *****************
; Defined at:
;		line 13 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Multiplication\Multiplication.c"
...
l30000688:	
;Multiplication.c: 15: TRISA=0X07;
	movlw	(07h)
...
l30000689:	
	line	16
;Multiplication.c: 16: TRISB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000690:	
	line	17
;Multiplication.c: 17: TRISC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000691:	
	line	19
;Multiplication.c: 19: PORTA=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000692:	
	line	20
;Multiplication.c: 20: PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000693:	
	line	21
;Multiplication.c: 21: PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000696:	
	line	27
;Multiplication.c: 27: char number[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
...
l30000697:	
	line	28
;Multiplication.c: 28: char number1[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
	movlw	(main@number1)&0ffh
	movwf	fsr0
	movlw	main@F773&0ffh
	movwf	(??_main+0+0)
	movf	fsr0,w
	movwf	(??_main+0+0+1)
	movlw	10
...
l30000701:	
	line	54
;Multiplication.c: 53: {
;Multiplication.c: 54: product=count1*count;
	...
	movf	(1+(?___wmul)),w
	clrf	(main@product+1)
	addwf	(main@product+1)
	movf	(0+(?___wmul)),w
	clrf	(main@product)
	addwf	(main@product)

	line	55
;Multiplication.c: 55: i=product/10;
	movf	(main@product+1),w
	clrf	(?___awdiv+1)
	addwf	(?___awdiv+1)
	movf	(main@product),w
	clrf	(?___awdiv)
	...
	line	56
;Multiplication.c: 56: j=product%10;
	movf	(main@product+1),w
	clrf	(?___awmod+1)
	addwf	(?___awmod+1)
	movf	(main@product),w
...
l30000702:	
	line	58
;Multiplication.c: 58: for(k=0;k<20;k++)
	movlw	low(0)
	movwf	(main@k)
	movlw	high(0)
	movwf	((main@k))+1
...
l18:	
	line	60
;Multiplication.c: 59: {
;Multiplication.c: 60: RB1=1;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(49/8),(49)&7
	line	61
;Multiplication.c: 61: RB0=0;
	bcf	(48/8),(48)&7
	
l30000705:	
	line	62
;Multiplication.c: 62: PORTC=number[i];
	movf	(main@i),w
...
l30000706:	
	line	63
;Multiplication.c: 63: time_delay(1000);
	movlw	low(03E8h)
	movwf	(?_time_delay)
	movlw	high(03E8h)
	movwf	((?_time_delay))+1
...
l30000708:	
	line	66
;Multiplication.c: 66: RB1=0;
	bcf	(49/8),(49)&7
	
l30000709:	
	line	67
;Multiplication.c: 67: PORTC=number1[j];
	movf	(main@j),w
	addlw	(main@number1)&0ffh
	movwf	fsr0
	bcf	status, 7	;select IRP bank0
	movf	indf,w
	movwf	(7)	;volatile
	line	68
;Multiplication.c: 68: time_delay(1000);
	movlw	low(03E8h)
	movwf	(?_time_delay)
	movlw	high(03E8h)
	movwf	((?_time_delay))+1
...
; Defined at:
;		line 8 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Multiplication\Multiplication.c"
; Parameters:    Size  Location     Type
;  x               2    0[BANK0 ] int 
; Auto vars:     Size  Location     Type
;		None
...
;Multiplication.c: 7: void time_delay(int x)
;Multiplication.c: 8: {
