...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Reverse\Reverse.c"
	line	20
...
; *************** function _main *****************
; Defined at:
;		line 9 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Reverse\Reverse.c"
...
l30000521:	
	line	20
;Reverse.c: 20: char number[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
...
l30000522:	
	line	25
;Reverse.c: 24: {
;Reverse.c: 25: for(i=0,j=9;i<10,j>=0;i++,j--)
	movlw	low(0)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(main@i)
...
; Defined at:
;		line 4 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Reverse\Reverse.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
...
;Reverse.c: 3: void time_delay(int x)
;Reverse.c: 4: {
