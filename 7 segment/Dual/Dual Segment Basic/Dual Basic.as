...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Dual Segment Basic\Dual Basic.c"
	line	21
...
; *************** function _main *****************
; Defined at:
;		line 9 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Dual Segment Basic\Dual Basic.c"
...
l30000645:	
	line	21
;Dual Basic.c: 20: static int count;
;Dual Basic.c: 21: char number[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
...
l30000650:	
	line	45
;Dual Basic.c: 45: RA0=0;
	bcf	(40/8),(40)&7
	
l30000651:	
	line	46
;Dual Basic.c: 46: PORTC = number[2];
	movf	0+(main@number)+02h,w
	movwf	(7)	;volatile
	
l30000652:	
	line	47
;Dual Basic.c: 47: time_delay(1000);
	movlw	low(03E8h)
	movwf	(?_time_delay)
	movlw	high(03E8h)
	movwf	((?_time_delay))+1
...
l30000654:	
	line	50
;Dual Basic.c: 50: RA1=0;
	bcf	(41/8),(41)&7
	
l30000655:	
	line	51
;Dual Basic.c: 51: PORTC = number[5];
	movf	0+(main@number)+05h,w
	movwf	(7)	;volatile
	
l30000656:	
	line	52
;Dual Basic.c: 52: time_delay(1000);
	movlw	low(03E8h)
	movwf	(?_time_delay)
	movlw	high(03E8h)
	movwf	((?_time_delay))+1
...
; Defined at:
;		line 4 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Dual Segment Basic\Dual Basic.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
...
;Dual Basic.c: 3: void time_delay(int x)
;Dual Basic.c: 4: {
