...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Manual Counter\Manual Counter.c"
	line	13
...
___awdiv@divisor:	; 2 bytes @ 0x7
	...
	global	?_main
?_main: ;@ 0x9
;Data sizes: Strings 0, constant 0, data 10, bss 6, persistent 0 stack 0
...
; *************** function _main *****************
; Defined at:
;		line 30 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Manual Counter\Manual Counter.c"
...
l30000590:	
;Manual Counter.c: 31: TRISA=0X03;
	movlw	(03h)
...
l30000591:	
	line	32
;Manual Counter.c: 32: TRISC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000592:	
	line	33
;Manual Counter.c: 33: TRISB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000593:	
	line	35
;Manual Counter.c: 35: PORTA=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000594:	
	line	36
;Manual Counter.c: 36: PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000595:	
	line	37
;Manual Counter.c: 37: PORTB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000598:	
	line	44
;Manual Counter.c: 43: {
;Manual Counter.c: 44: configure();
	fcall	_configure
	
l30000599:	
	line	45
;Manual Counter.c: 45: if(RA0==1)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(40/8),(40)&7
	goto	u251
...
l30000606:	
	line	59
;Manual Counter.c: 57: }
;Manual Counter.c: 59: a=count/10;
	movf	(_count+1),w
	clrf	(?___awdiv+1)
	addwf	(?___awdiv+1)
	movf	(_count),w
	...
	line	60
;Manual Counter.c: 60: b=count%10;
	movf	(_count+1),w
	clrf	(?___awmod+1)
	addwf	(?___awmod+1)
	movf	(_count),w
...
; *************** function _configure *****************
; Defined at:
;		line 16 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Manual Counter\Manual Counter.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
;Manual Counter.c: 13: char number[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
;Manual Counter.c: 15: void configure()
;Manual Counter.c: 16: {
...
l30000584:	
;Manual Counter.c: 17: RB1=1;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bsf	(49/8),(49)&7
	line	18
;Manual Counter.c: 18: RB0=0;
	bcf	(48/8),(48)&7
	
l30000585:	
	line	19
;Manual Counter.c: 19: PORTC=number[a];
	movf	(_a),w
	addlw	(_number)&0ffh
	movwf	fsr0
	bcf	status, 7	;select IRP bank0
...
l30000586:	
	line	20
;Manual Counter.c: 20: time_delay(1000);
	movlw	low(03E8h)
	movwf	(?_time_delay)
	movlw	high(03E8h)
	movwf	((?_time_delay))+1
...
l30000588:	
	line	23
;Manual Counter.c: 23: RB1=0;
	bcf	(49/8),(49)&7
	
l30000589:	
	line	24
;Manual Counter.c: 24: PORTC=number[b];
	movf	(_b),w
	addlw	(_number)&0ffh
	movwf	fsr0
	bcf	status, 7	;select IRP bank0
	...
	movwf	(7)	;volatile
	line	25
;Manual Counter.c: 25: time_delay(1000);
	movlw	low(03E8h)
	movwf	(?_time_delay)
	movlw	high(03E8h)
	movwf	((?_time_delay))+1
...
; Defined at:
;		line 10 in file "C:\Users\gowth\Documents\PIC Programs\7 segment\Dual\Manual Counter\Manual Counter.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
