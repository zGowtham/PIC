...
; *************** function _main *****************
; Defined at:
;		line 109 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
	line	109
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;Vref Base1.c: 108: void main()
;Vref Base1.c: 109: {
...
l30000993:	
;Vref Base1.c: 110: TRISA=0X0D; PORTA=0X00;
	movlw	(0Dh)
...
l30000995:	
	line	111
;Vref Base1.c: 111: TRISD=0X00; PORTD=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000997:	
	line	112
;Vref Base1.c: 112: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000999:	
	line	113
;Vref Base1.c: 113: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30001000:	
	...
	movwf	(9)	;volatile
	line	115
;Vref Base1.c: 115: ANSEL=0X01; ANSELH=0X00;
...
l30001002:	
	line	117
;Vref Base1.c: 117: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30001003:	
	line	118
;Vref Base1.c: 118: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30001004:	
	line	120
;Vref Base1.c: 120: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30001005:	
	line	121
;Vref Base1.c: 121: data('0');
	movlw	(030h)
	fcall	_data
	
l30001006:	
	line	122
;Vref Base1.c: 122: data('0');
	movlw	(030h)
	fcall	_data
...
l30001007:	
	line	126
;Vref Base1.c: 125: {
;Vref Base1.c: 126: adc();
	fcall	_adc
	
l30001008:	
	line	127
;Vref Base1.c: 127: voltage();
	fcall	_voltage
	goto	l30001007
	global	start
	ljmp	start
...
; *************** function _adc *****************
; Defined at:
;		line 54 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000914:	
;Vref Base1.c: 55: ADCON0=0X83; ADCON1=0XB0;
	movlw	(083h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(31)	;volatile
...
l30000915:	
	line	57
;Vref Base1.c: 57: high=ADRESH; low=ADRESL;
	movf	(30),w	;volatile
	movwf	(??_adc+0+0)
	clrf	(??_adc+0+0+1)
	movf	0+(??_adc+0+0),w
...
; *************** function _voltage *****************
; Defined at:
;		line 86 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;  z               3   41[BANK0 ] float 
...
l30000992:	
;Vref Base1.c: 88: command(0XC0);
	movlw	(0C0h)
	fcall	_command
	line	92
;Vref Base1.c: 89: int a,b,c,d;
;Vref Base1.c: 90: float z;
;Vref Base1.c: 92: z=(DV*3.0)/1023.0;
	movf	(_DV+1),w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(?___awtoft+1)
...
;Vref Base1.c: 97: c=d%10;
	...
	line	99
;Vref Base1.c: 99: data(a+48);
	movf	(voltage@a),w
	addlw	030h
	fcall	_data
	line	100
;Vref Base1.c: 100: data(0X2E);
	movlw	(02Eh)
	fcall	_data
	line	101
;Vref Base1.c: 101: data(b+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(voltage@b),w
	addlw	030h
...
;Vref Base1.c: 102: data(c+48);
	...
	fcall	_data
	line	103
;Vref Base1.c: 103: data(0X20);
	movlw	(020h)
	fcall	_data
	line	104
;Vref Base1.c: 104: data(0X56);
	movlw	(056h)
	fcall	_data
...
; *************** function _count *****************
; Defined at:
;		line 38 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
;  i               2   22[BANK0 ] int 
; Auto vars:     Size  Location     Type
;  f               2   16[BANK0 ] int 
...
;Vref Base1.c: 37: void count(int i)
;Vref Base1.c: 38: {
...
l30000913:	
;Vref Base1.c: 39: int a,c,e,f;
;Vref Base1.c: 41: a=i/1000;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(count@i+1),w
	clrf	(?___awdiv+1)
...
;Vref Base1.c: 44: f=i%10;
	...
	line	46
;Vref Base1.c: 46: command(0X80);
	movlw	(080h)
	fcall	_command
	line	47
;Vref Base1.c: 47: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(count@a),w
	addlw	030h
...
; *************** function _data *****************
; Defined at:
;		line 31 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
...
;Vref Base1.c: 30: void data(char data)
;Vref Base1.c: 31: {
...
l30000951:	
	line	33
;Vref Base1.c: 33: PORTD=data;
	movf	(data@data),w
	movwf	(8)	;volatile
	
l30000952:	
	line	34
;Vref Base1.c: 34: pulse();
	fcall	_pulse
...
; *************** function _command *****************
; Defined at:
;		line 24 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;Vref Base1.c: 23: void command(char data)
;Vref Base1.c: 24: {
...
l30000948:	
	line	26
;Vref Base1.c: 26: PORTD=data;
	movf	(command@data),w
	movwf	(8)	;volatile
	
l30000949:	
	line	27
;Vref Base1.c: 27: pulse();
	fcall	_pulse
...
; *************** function _pulse *****************
; Defined at:
;		line 16 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000955:	
	line	19
;Vref Base1.c: 19: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	20
;Vref Base1.c: 20: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 11 in file "C:\Users\gowth\Documents\PIC Programs\ADC\Vref Base\Vref Base1.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
