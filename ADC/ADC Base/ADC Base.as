...
; *************** function _main *****************
; Defined at:
;		line 109 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
	line	109
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;ADC Base.c: 108: void main()
;ADC Base.c: 109: {
...
l30000993:	
;ADC Base.c: 110: TRISA=0X01; PORTA=0X00;
	movlw	(01h)
...
l30000995:	
	line	111
;ADC Base.c: 111: TRISD=0X00; PORTD=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000997:	
	line	112
;ADC Base.c: 112: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000999:	
	line	113
;ADC Base.c: 113: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30001000:	
	...
	movwf	(9)	;volatile
	line	115
;ADC Base.c: 115: ANSEL=0X01; ANSELH=0X00;
...
l30001002:	
	line	117
;ADC Base.c: 117: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30001003:	
	line	118
;ADC Base.c: 118: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30001004:	
	line	120
;ADC Base.c: 120: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30001005:	
	line	121
;ADC Base.c: 121: data('0');
	movlw	(030h)
	fcall	_data
	
l30001006:	
	line	122
;ADC Base.c: 122: data('0');
	movlw	(030h)
	fcall	_data
...
; *************** function _adc *****************
; Defined at:
;		line 54 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000914:	
;ADC Base.c: 55: ADCON0=0X83; ADCON1=0X80;
	movlw	(083h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(31)	;volatile
...
l30000915:	
	line	57
;ADC Base.c: 57: high=ADRESH; low=ADRESL;
	movf	(30),w	;volatile
	movwf	(??_adc+0+0)
	clrf	(??_adc+0+0+1)
	movf	0+(??_adc+0+0),w
...
; *************** function _voltage *****************
; Defined at:
;		line 86 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;  z               3   41[BANK0 ] float 
...
l30000992:	
;ADC Base.c: 88: command(0XC0);
	movlw	(0C0h)
	fcall	_command
	line	92
;ADC Base.c: 89: int a,b,c,d;
;ADC Base.c: 90: float z;
;ADC Base.c: 92: z=(DV*5.0)/1023.0;
	movf	(_DV+1),w
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	clrf	(?___awtoft+1)
...
;ADC Base.c: 97: c=d%10;
	...
	line	99
;ADC Base.c: 99: data(a+48);
	movf	(voltage@a),w
	addlw	030h
	fcall	_data
	line	100
;ADC Base.c: 100: data(0X2E);
	movlw	(02Eh)
	fcall	_data
	line	101
;ADC Base.c: 101: data(b+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(voltage@b),w
	addlw	030h
...
;ADC Base.c: 102: data(c+48);
	...
	fcall	_data
	line	103
;ADC Base.c: 103: data(0X20);
	movlw	(020h)
	fcall	_data
	line	104
;ADC Base.c: 104: data(0X56);
	movlw	(056h)
	fcall	_data
...
; *************** function _count *****************
; Defined at:
;		line 38 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
;  i               2   22[BANK0 ] int 
; Auto vars:     Size  Location     Type
;  f               2   16[BANK0 ] int 
...
;ADC Base.c: 37: void count(int i)
;ADC Base.c: 38: {
...
l30000913:	
;ADC Base.c: 39: int a,c,e,f;
;ADC Base.c: 41: a=i/1000;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(count@i+1),w
	clrf	(?___awdiv+1)
...
;ADC Base.c: 44: f=i%10;
	...
	line	46
;ADC Base.c: 46: command(0X80);
	movlw	(080h)
	fcall	_command
	line	47
;ADC Base.c: 47: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(count@a),w
	addlw	030h
...
; *************** function _data *****************
; Defined at:
;		line 31 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
...
;ADC Base.c: 30: void data(char data)
;ADC Base.c: 31: {
...
; *************** function _command *****************
; Defined at:
;		line 24 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;ADC Base.c: 23: void command(char data)
;ADC Base.c: 24: {
...
; *************** function _pulse *****************
; Defined at:
;		line 16 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
; *************** function _delay *****************
; Defined at:
;		line 11 in file "C:\Users\gowth\Documents\PIC Programs\ADC\ADC Base\ADC Base.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
