...
; *************** function _main *****************
; Defined at:
;		line 46 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Counter0\Counter Base\Counter Base1.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\Timer\Counter0\Counter Base\Counter Base1.c"
	line	46
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;Counter Base1.c: 45: void main()
;Counter Base1.c: 46: {
...
l30000605:	
;Counter Base1.c: 47: TRISD=0X00; PORTD=0X00; ANSEL=0; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	48
;Counter Base1.c: 48: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(7)	;volatile
	line	49
;Counter Base1.c: 49: TRISB=0X00; PORTB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000606:	
	line	50
;Counter Base1.c: 50: TRISA=0X10; PORTA=0X00;
	movlw	(010h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l30000608:	
	line	51
;Counter Base1.c: 51: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000610:	
	line	53
;Counter Base1.c: 53: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000611:	
	line	54
;Counter Base1.c: 54: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30000612:	
	line	56
;Counter Base1.c: 56: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000613:	
	line	57
;Counter Base1.c: 57: data('0');
	movlw	(030h)
	fcall	_data
	
l30000614:	
	line	58
;Counter Base1.c: 58: command(0X81);
	movlw	(081h)
	fcall	_command
	
l30000615:	
	line	59
;Counter Base1.c: 59: data('0');
	movlw	(030h)
	fcall	_data
	line	62
;Counter Base1.c: 62: OPTION=0X20;
	movlw	(020h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(129)^080h
...
l30000617:	
	line	66
;Counter Base1.c: 66: int count=0;
	movlw	low(0)
	movwf	(main@count)
	movlw	high(0)
	movwf	((main@count))+1
...
l30000624:	
	line	86
;Counter Base1.c: 86: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000625:	
	line	87
;Counter Base1.c: 87: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@a),w
	addlw	030h
...
l30000626:	
	line	88
;Counter Base1.c: 88: command(0X81);
	movlw	(081h)
	fcall	_command
	
l30000627:	
	line	89
;Counter Base1.c: 89: data(b+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@b),w
	addlw	030h
...
l30000628:	
	line	93
;Counter Base1.c: 93: command(0XC0);
	movlw	(0C0h)
	fcall	_command
	line	94
;Counter Base1.c: 94: data(c+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@c),w
	addlw	030h
	fcall	_data
	line	95
;Counter Base1.c: 95: command(0XC1);
	movlw	(0C1h)
	fcall	_command
	line	96
;Counter Base1.c: 96: data(d+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(main@d),w
	addlw	030h
...
; *************** function _data *****************
; Defined at:
;		line 30 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Counter0\Counter Base\Counter Base1.c"
; Parameters:    Size  Location     Type
...
;Counter Base1.c: 29: void data(char data)
;Counter Base1.c: 30: {
...
l30000648:	
	line	32
;Counter Base1.c: 32: PORTD=data;
	movf	(data@data),w
	movwf	(8)	;volatile
	
l30000649:	
	line	33
;Counter Base1.c: 33: pulse();
	fcall	_pulse
...
; *************** function _command *****************
; Defined at:
;		line 23 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Counter0\Counter Base\Counter Base1.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;Counter Base1.c: 22: void command(char data)
;Counter Base1.c: 23: {
...
l30000651:	
	line	25
;Counter Base1.c: 25: PORTD=data;
	movf	(command@data),w
	movwf	(8)	;volatile
	
l30000652:	
	line	26
;Counter Base1.c: 26: pulse();
	fcall	_pulse
...
; *************** function _pulse *****************
; Defined at:
;		line 15 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Counter0\Counter Base\Counter Base1.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000674:	
	line	18
;Counter Base1.c: 18: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	19
;Counter Base1.c: 19: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 10 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Counter0\Counter Base\Counter Base1.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
...
;Counter Base1.c: 9: void delay(int x)
;Counter Base1.c: 10: {
