...
; *************** function _main *****************
; Defined at:
;		line 6 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\60ms\60ms.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\60ms\60ms.c"
	line	6
...
l30000505:	
;60ms.c: 7: TRISD=0X00; PORTD=0X00; ANSEL=0; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	8
;60ms.c: 8: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(7)	;volatile
	line	9
;60ms.c: 9: TRISB=0X00; PORTB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(6)	;volatile
	line	10
;60ms.c: 10: TRISA=0X00; PORTA=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
