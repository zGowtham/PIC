...
z	equ	0
pclath	equ	10
# 2 "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
...
; *************** function _main *****************
; Defined at:
;		line 53 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
	line	53
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;LCD Counter.c: 52: void main()
;LCD Counter.c: 53: {
...
l30000612:	
;LCD Counter.c: 54: TRISD=0X00; PORTD=0X00; ANSEL=0; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	55
;LCD Counter.c: 55: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000613:	
	line	56
;LCD Counter.c: 56: TRISB=0X01; PORTB=0X00;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l30000614:	
	...
	movwf	(6)	;volatile
	line	57
;LCD Counter.c: 57: TRISA=0X01; PORTA=0X00;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l30000616:	
	line	58
;LCD Counter.c: 58: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000618:	
	line	61
;LCD Counter.c: 61: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000619:	
	line	62
;LCD Counter.c: 62: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30000620:	
	line	64
;LCD Counter.c: 64: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000621:	
	line	65
;LCD Counter.c: 65: data('0');
	movlw	(030h)
	fcall	_data
	
l30000622:	
	line	66
;LCD Counter.c: 66: command(0X81);
	movlw	(081h)
	fcall	_command
	
l30000623:	
	line	67
;LCD Counter.c: 67: data('1');
	movlw	(031h)
	fcall	_data
	
l30000624:	
	line	68
;LCD Counter.c: 68: command(0X83);
	movlw	(083h)
	fcall	_command
	
l30000625:	
	line	69
;LCD Counter.c: 69: string("Seconds");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_string
	
l30000626:	
	line	71
;LCD Counter.c: 71: OPTION=0X05;
	movlw	(05h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(129)^080h
...
l30000631:	
	line	86
;LCD Counter.c: 86: T0IF=0;
	bcf	(90/8),(90)&7
	line	87
;LCD Counter.c: 87: TMR0=131;
	movlw	(083h)
	movwf	(1)	;volatile
...
;LCD Counter.c: 89: }
;LCD Counter.c: 90: }
;LCD Counter.c: 92: time=count/125;
	movf	(_count+1),w
	clrf	(?___awdiv+1)
	addwf	(?___awdiv+1)
	movf	(_count),w
...
;LCD Counter.c: 95: b=time%10;
	...
	line	97
;LCD Counter.c: 97: command(0X80);
	movlw	(080h)
	fcall	_command
	line	98
;LCD Counter.c: 98: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
	fcall	_data
	line	99
;LCD Counter.c: 99: command(0X81);
	movlw	(081h)
	fcall	_command
	line	100
;LCD Counter.c: 100: data(b+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_b),w
	addlw	030h
...
; *************** function _string *****************
; Defined at:
;		line 44 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
; Parameters:    Size  Location     Type
...
;LCD Counter.c: 43: void string(char *ptr)
;LCD Counter.c: 44: {
...
; *************** function _command *****************
; Defined at:
;		line 30 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
; Parameters:    Size  Location     Type
...
;LCD Counter.c: 29: void command(char data)
;LCD Counter.c: 30: {
...
l30000676:	
	line	32
;LCD Counter.c: 32: PORTD=data;
	movf	(command@data),w
	movwf	(8)	;volatile
	
l30000677:	
	line	33
;LCD Counter.c: 33: pulse();
	fcall	_pulse
...
; *************** function _data *****************
; Defined at:
;		line 37 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;LCD Counter.c: 36: void data(char data)
;LCD Counter.c: 37: {
...
l30000679:	
	line	39
;LCD Counter.c: 39: PORTD=data;
	movf	(data@data),w
	movwf	(8)	;volatile
	
l30000680:	
	line	40
;LCD Counter.c: 40: pulse();
	fcall	_pulse
...
; *************** function _pulse *****************
; Defined at:
;		line 22 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000683:	
	line	25
;LCD Counter.c: 25: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	26
;LCD Counter.c: 26: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 17 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\LCD counter\LCD Counter.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
