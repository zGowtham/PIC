...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\Timer0 Traffic\Timer0 Traffic.c"
	line	4
...
; *************** function _main *****************
; Defined at:
;		line 9 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer0\Timer0 Traffic\Timer0 Traffic.c"
...
l30000567:	
;Timer0 Traffic.c: 10: TRISB=0X00; PORTB=0X00; ANSEL=0; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	11
;Timer0 Traffic.c: 11: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000568:	
	line	13
;Timer0 Traffic.c: 13: OPTION=0X05;
	movlw	(05h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
	movwf	(129)^080h
...
l30000571:	
	line	21
;Timer0 Traffic.c: 21: T0IF=0;
	bcf	(90/8),(90)&7
	line	22
;Timer0 Traffic.c: 22: TMR0=131;
	movlw	(083h)
	movwf	(1)	;volatile
...
l30000572:	
	line	25
;Timer0 Traffic.c: 23: }
;Timer0 Traffic.c: 25: if(count==0)
	movf	((_count+1)),w
	iorwf	((_count)),w
	skipz
	goto	u221
...
l30000573:	
	line	27
;Timer0 Traffic.c: 26: {
;Timer0 Traffic.c: 27: RC0=1;
	bsf	(56/8),(56)&7
	line	28
;Timer0 Traffic.c: 28: RC1=1;
	bsf	(57/8),(57)&7
	line	29
;Timer0 Traffic.c: 29: RC2=1;
	bsf	(58/8),(58)&7
	
l30000574:	
	line	32
;Timer0 Traffic.c: 30: }
;Timer0 Traffic.c: 32: if(count%500==0)
	movf	(_count+1),w
	clrf	(?___awmod+1)
	addwf	(?___awmod+1)
	movf	(_count),w
...
;Timer0 Traffic.c: 42: }
;Timer0 Traffic.c: 43: }
;Timer0 Traffic.c: 45: if(count%125==0)
	movf	(_count+1),w
	clrf	(?___awmod+1)
	addwf	(?___awmod+1)
	movf	(_count),w
...
;Timer0 Traffic.c: 55: }
;Timer0 Traffic.c: 56: }
;Timer0 Traffic.c: 58: if(count%375==0)
	movf	(_count+1),w
	clrf	(?___awmod+1)
	addwf	(?___awmod+1)
	movf	(_count),w
...
l30000587:	
	line	63
;Timer0 Traffic.c: 62: {
;Timer0 Traffic.c: 63: RC2=1;
	bsf	(58/8),(58)&7
	
l14:	
	line	65
;Timer0 Traffic.c: 64: }
;Timer0 Traffic.c: 65: if(b%2==0)
	btfsc	(_b),(0)&7
	goto	u311
	goto	u310
u311:
