...
; *************** function _main *****************
; Defined at:
;		line 98 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
	line	98
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;LCD counter 2 T1.c: 97: void main()
;LCD counter 2 T1.c: 98: {
...
l30000632:	
;LCD counter 2 T1.c: 99: TRISD=0X00; PORTD=0X00; ANSEL=0; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	100
;LCD counter 2 T1.c: 100: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(7)	;volatile
	line	101
;LCD counter 2 T1.c: 101: TRISB=0X00; PORTB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(6)	;volatile
	line	102
;LCD counter 2 T1.c: 102: TRISA=0X00; PORTA=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(5)	;volatile
	line	103
;LCD counter 2 T1.c: 103: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000633:	
	line	105
;LCD counter 2 T1.c: 105: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000634:	
	line	106
;LCD counter 2 T1.c: 106: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30000635:	
	line	108
;LCD counter 2 T1.c: 108: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000636:	
	line	109
;LCD counter 2 T1.c: 109: data('0');
	movlw	(030h)
	fcall	_data
	
l30000637:	
	line	110
;LCD counter 2 T1.c: 110: command(0X81);
	movlw	(081h)
	fcall	_command
	
l30000638:	
	line	111
;LCD counter 2 T1.c: 111: data('0');
	movlw	(030h)
	fcall	_data
	
l30000639:	
	line	112
;LCD counter 2 T1.c: 112: command(0X83);
	movlw	(083h)
	fcall	_command
	
l30000640:	
	line	113
;LCD counter 2 T1.c: 113: string("Seconds");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_string
	
l30000641:	
	line	115
;LCD counter 2 T1.c: 115: T1CON=0X39;
	movlw	(039h)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(16)
...
l30000642:	
	line	117
;LCD counter 2 T1.c: 117: TMR1L=0XDC;
	movlw	(0DCh)
	movwf	(14)	;volatile
	
l30000643:	
	line	118
;LCD counter 2 T1.c: 118: TMR1H=0X0B;
	movlw	(0Bh)
	movwf	(15)	;volatile
	
l30000644:	
	line	123
;LCD counter 2 T1.c: 121: {
;LCD counter 2 T1.c: 123: timer();
	fcall	_timer
	goto	l30000644
	global	start
	ljmp	start
...
; *************** function _timer *****************
; Defined at:
;		line 55 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
;LCD counter 2 T1.c: 54: void timer()
;LCD counter 2 T1.c: 55: {
...
l30000619:	
;LCD counter 2 T1.c: 57: if(RB0==1)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	btfss	(48/8),(48)&7
	goto	u271
...
l30000620:	
	line	59
;LCD counter 2 T1.c: 58: {
;LCD counter 2 T1.c: 59: account++;
	movlw	low(01h)
	addwf	(_account),f
	skipnc
	incf	(_account+1),f
...
l30000621:	
	line	60
;LCD counter 2 T1.c: 60: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000622:	
	line	61
;LCD counter 2 T1.c: 61: data('0');
	movlw	(030h)
	fcall	_data
	
l30000623:	
	line	62
;LCD counter 2 T1.c: 62: command(0X81);
	movlw	(081h)
	fcall	_command
	
l30000624:	
	line	63
;LCD counter 2 T1.c: 63: data('0');
	movlw	(030h)
	fcall	_data
...
l30000625:	
	line	68
;LCD counter 2 T1.c: 66: }
;LCD counter 2 T1.c: 68: if(account==1)
	movlw	01h
	xorwf	(_account),w
	iorwf	(_account+1),w
	skipz
...
l30000626:	
	line	72
;LCD counter 2 T1.c: 69: {
;LCD counter 2 T1.c: 72: if(TMR1IF==1)
	btfss	(96/8),(96)&7
	goto	u301
	goto	u300
u301:
...
l30000627:	
	line	74
;LCD counter 2 T1.c: 73: {
;LCD counter 2 T1.c: 74: count++;
	movlw	low(01h)
	addwf	(_count),f
	skipnc
	incf	(_count+1),f
...
l30000628:	
	line	75
;LCD counter 2 T1.c: 75: TMR1IF=0;
	bcf	(96/8),(96)&7
	line	76
;LCD counter 2 T1.c: 76: TMR1L=0XDC;
	movlw	(0DCh)
	movwf	(14)	;volatile
	line	77
;LCD counter 2 T1.c: 77: TMR1H=0X0B;
	movlw	(0Bh)
	movwf	(15)	;volatile
	
l17:	
	line	81
;LCD counter 2 T1.c: 78: }
;LCD counter 2 T1.c: 79: }
;LCD counter 2 T1.c: 81: if(account==2)
	movlw	02h
	xorwf	(_account),w
	iorwf	(_account+1),w
	skipz
...
l30000629:	
	line	83
;LCD counter 2 T1.c: 82: {
;LCD counter 2 T1.c: 83: time=count/2;
	movf	(_count+1),w
	clrf	(?___awdiv+1)
	addwf	(?___awdiv+1)
	movf	(_count),w
	...
	line	85
;LCD counter 2 T1.c: 85: a=time/10;
	movf	(_time+1),w
	clrf	(?___awdiv+1)
	addwf	(?___awdiv+1)
	movf	(_time),w
	...
	line	86
;LCD counter 2 T1.c: 86: b=time%10;
	movf	(_time+1),w
	clrf	(?___awmod+1)
	addwf	(?___awmod+1)
	movf	(_time),w
	...
	line	88
;LCD counter 2 T1.c: 88: command(0X80);
	movlw	(080h)
	fcall	_command
	line	89
;LCD counter 2 T1.c: 89: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
	fcall	_data
	line	90
;LCD counter 2 T1.c: 90: command(0X81);
	movlw	(081h)
	fcall	_command
	line	91
;LCD counter 2 T1.c: 91: data(b+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_b),w
	addlw	030h
...
l30000630:	
	line	92
;LCD counter 2 T1.c: 92: account=0;
	movlw	low(0)
	movwf	(_account)
	movlw	high(0)
	movwf	((_account))+1
...
; *************** function _string *****************
; Defined at:
;		line 46 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
; Parameters:    Size  Location     Type
...
;LCD counter 2 T1.c: 45: void string(char *ptr)
;LCD counter 2 T1.c: 46: {
...
l30000667:	
	line	49
;LCD counter 2 T1.c: 48: {
;LCD counter 2 T1.c: 49: data(*ptr);
	movf	(string@ptr),w
...
; *************** function _command *****************
; Defined at:
;		line 32 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
; Parameters:    Size  Location     Type
...
;LCD counter 2 T1.c: 31: void command(char data)
;LCD counter 2 T1.c: 32: {
...
l30000671:	
	line	34
;LCD counter 2 T1.c: 34: PORTD=data;
	movf	(command@data),w
	movwf	(8)	;volatile
	
l30000672:	
	line	35
;LCD counter 2 T1.c: 35: pulse();
	fcall	_pulse
...
; *************** function _data *****************
; Defined at:
;		line 39 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;LCD counter 2 T1.c: 38: void data(char data)
;LCD counter 2 T1.c: 39: {
...
l30000664:	
	line	41
;LCD counter 2 T1.c: 41: PORTD=data;
	movf	(data@data),w
	movwf	(8)	;volatile
	
l30000665:	
	line	42
;LCD counter 2 T1.c: 42: pulse();
	fcall	_pulse
...
; *************** function _pulse *****************
; Defined at:
;		line 24 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
;LCD counter 2 T1.c: 23: void pulse()
;LCD counter 2 T1.c: 24: {
...
l30000693:	
	line	26
;LCD counter 2 T1.c: 26: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
l30000694:	
	line	27
;LCD counter 2 T1.c: 27: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	28
;LCD counter 2 T1.c: 28: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 19 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\LCD counter 2 T1\LCD counter 2 T1.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
