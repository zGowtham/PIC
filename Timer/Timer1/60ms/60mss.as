...
; *************** function _main *****************
; Defined at:
;		line 6 in file "C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\60ms\60mss.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\Timer\Timer1\60ms\60mss.c"
	line	6
...
l30000505:	
;60mss.c: 7: TRISD=0X00; PORTD=0X00; ANSEL=0; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	8
;60mss.c: 8: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000506:	
	line	11
;60mss.c: 11: T1CON=0X39;
	movlw	(039h)
	movwf	(16)
	
l30000507:	
	line	13
;60mss.c: 13: TMR1L=0XDC;
	movlw	(0DCh)
	movwf	(14)	;volatile
	
l30000508:	
	line	14
;60mss.c: 14: TMR1H=0X0B;
	movlw	(0Bh)
	movwf	(15)	;volatile
...
;60mss.c: 22: TMR1IF=0;
	bcf	(96/8),(96)&7
	line	23
;60mss.c: 23: TMR1L=0XDC;
	movlw	(0DCh)
	movwf	(14)	;volatile
	line	24
;60mss.c: 24: TMR1H=0X0B;
	movlw	(0Bh)
	movwf	(15)	;volatile
