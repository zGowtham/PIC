...
z	equ	0
pclath	equ	10
# 2 "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
	psect config,class=CONFIG,delta=2 ;#
# 2 "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
	dw 0X2CE4 ;#
# 10 "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
	psect config,class=CONFIG,delta=2 ;#
# 10 "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
	dw 0X2CE4 ;#
...
___awdiv@divisor:	; 2 bytes @ 0x2
	ds	2
;Data sizes: Strings 0, constant 0, data 0, bss 12, persistent 2 stack 0
...
; *************** function _main *****************
; Defined at:
;		line 41 in file "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
	line	41
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;0-999.c: 40: void main()
;0-999.c: 41: {
...
l30000695:	
;0-999.c: 42: TRISD=0X00; PORTD=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	43
;0-999.c: 43: TRISE=0X00; PORTE=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000696:	
	line	44
;0-999.c: 44: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000697:	
	line	45
;0-999.c: 45: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30000698:	
	line	47
;0-999.c: 47: command(0X01);
	movlw	(01h)
	fcall	_command
...
;0-999.c: 61: f=d%10;
	...
	line	63
;0-999.c: 63: command(0X80);
	movlw	(080h)
	fcall	_command
	line	64
;0-999.c: 64: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
...
; *************** function _data *****************
; Defined at:
;		line 34 in file "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
; Parameters:    Size  Location     Type
...
;0-999.c: 33: void data(char data)
;0-999.c: 34: {
...
; *************** function _command *****************
; Defined at:
;		line 27 in file "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;0-999.c: 26: void command(char data)
;0-999.c: 27: {
...
; *************** function _pulse *****************
; Defined at:
;		line 19 in file "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
; *************** function _delay *****************
; Defined at:
;		line 14 in file "C:\Users\gowth\Documents\PIC Programs\LCD\0-999\0-999.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
