...
; *************** function _main *****************
; Defined at:
;		line 65 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 3\4 bit mode 3.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 3\4 bit mode 3.c"
	line	65
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;4 bit mode 3.c: 64: void main()
;4 bit mode 3.c: 65: {
...
l30000695:	
;4 bit mode 3.c: 66: int i;
;4 bit mode 3.c: 68: TRISD=0X00; PORTD=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	69
;4 bit mode 3.c: 69: TRISE=0X00; PORTE=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000696:	
	line	70
;4 bit mode 3.c: 70: TRISB=0X07; PORTB=0X00;
	movlw	(07h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l30000698:	
	line	72
;4 bit mode 3.c: 72: command(0X02);
	movlw	(02h)
	fcall	_command
	
l30000699:	
	line	73
;4 bit mode 3.c: 73: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000700:	
	line	74
;4 bit mode 3.c: 74: command(0X28);
	movlw	(028h)
	fcall	_command
...
l30000701:	
	line	79
;4 bit mode 3.c: 78: {
;4 bit mode 3.c: 79: for(i=0;i<1000;i++)
	movlw	low(0)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movwf	(main@i)
...
;4 bit mode 3.c: 89: f=d%10;
	...
	line	91
;4 bit mode 3.c: 91: command(0X80);
	movlw	(080h)
	fcall	_command
	line	92
;4 bit mode 3.c: 92: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
...
; *************** function _data *****************
; Defined at:
;		line 47 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 3\4 bit mode 3.c"
; Parameters:    Size  Location     Type
...
;4 bit mode 3.c: 46: void data(char data)
;4 bit mode 3.c: 47: {
...
l30000708:	
	line	49
;4 bit mode 3.c: 49: PORTD=(data&0XF0);
	movf	(data@data),w
	andlw	0F0h
	movwf	(8)	;volatile
...
l30000709:	
	line	50
;4 bit mode 3.c: 50: pulse();
	fcall	_pulse
	
l30000710:	
	line	51
;4 bit mode 3.c: 51: PORTD=(data&0X0F)<<4;
	movf	(data@data),w
	andlw	0Fh
	movwf	(??_data+0+0)
	movlw	(04h)-1
...
; *************** function _command *****************
; Defined at:
;		line 38 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 3\4 bit mode 3.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    3[COMMON] unsigned char 
...
;4 bit mode 3.c: 37: void command(char data)
;4 bit mode 3.c: 38: {
...
l30000732:	
	line	40
;4 bit mode 3.c: 40: PORTD=(data&0XF0);
	movf	(command@data),w
	andlw	0F0h
	movwf	(8)	;volatile
...
l30000733:	
	line	41
;4 bit mode 3.c: 41: pulse();
	fcall	_pulse
	
l30000734:	
	line	42
;4 bit mode 3.c: 42: PORTD=(data&0X0F)<<4;
	movf	(command@data),w
	andlw	0Fh
	movwf	(??_command+0+0)
	movlw	(04h)-1
...
; *************** function _pulse *****************
; Defined at:
;		line 30 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 3\4 bit mode 3.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000756:	
	line	33
;4 bit mode 3.c: 33: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	34
;4 bit mode 3.c: 34: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 25 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 3\4 bit mode 3.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
