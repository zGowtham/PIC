...
?_main: ;@ 0x6
	global	?_string
?_string: ;@ 0x6
;Data sizes: Strings 16, constant 0, data 0, bss 8, persistent 0 stack 0
...
; *************** function _main *****************
; Defined at:
;		line 57 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
	line	57
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;4 bit mode 4.c: 56: void main()
;4 bit mode 4.c: 57: {
...
l30000532:	
;4 bit mode 4.c: 58: int i;
;4 bit mode 4.c: 60: TRISD=0X00; PORTD=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	61
;4 bit mode 4.c: 61: TRISE=0X00; PORTE=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000533:	
	line	62
;4 bit mode 4.c: 62: TRISB=0X07; PORTB=0X00;
	movlw	(07h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l30000535:	
	line	64
;4 bit mode 4.c: 64: command(0X02);
	movlw	(02h)
	fcall	_command
	
l30000536:	
	line	65
;4 bit mode 4.c: 65: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000537:	
	line	66
;4 bit mode 4.c: 66: command(0X28);
	movlw	(028h)
	fcall	_command
...
l30000538:	
	line	70
;4 bit mode 4.c: 69: {
;4 bit mode 4.c: 70: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000539:	
	line	71
;4 bit mode 4.c: 71: string("Gowtham");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_string
	
l30000540:	
	line	72
;4 bit mode 4.c: 72: command(0XC0);
	movlw	(0C0h)
	fcall	_command
	
l30000541:	
	line	73
;4 bit mode 4.c: 73: string("GOWTHAM");
...
; *************** function _string *****************
; Defined at:
;		line 48 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
; Parameters:    Size  Location     Type
...
;4 bit mode 4.c: 47: void string(char *ptr)
;4 bit mode 4.c: 48: {
...
; *************** function _command *****************
; Defined at:
;		line 29 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
; Parameters:    Size  Location     Type
...
;4 bit mode 4.c: 28: void command(char data)
;4 bit mode 4.c: 29: {
...
l30000519:	
	line	31
;4 bit mode 4.c: 31: PORTD=(data&0XF0)>>4;
	movf	(command@data),w
	movwf	(??_command+0+0)
	movlw	04h
u25:
...
l30000520:	
	line	32
;4 bit mode 4.c: 32: pulse();
	fcall	_pulse
	
l30000521:	
	line	33
;4 bit mode 4.c: 33: PORTD=(data&0X0F);
	movf	(command@data),w
	andlw	0Fh
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
; *************** function _data *****************
; Defined at:
;		line 38 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    3[COMMON] unsigned char 
...
;4 bit mode 4.c: 37: void data(char data)
;4 bit mode 4.c: 38: {
...
l30000524:	
	line	40
;4 bit mode 4.c: 40: PORTD=(data&0XF0)>>4;
	movf	(data@data),w
	movwf	(??_data+0+0)
	movlw	04h
u35:
...
l30000525:	
	line	41
;4 bit mode 4.c: 41: pulse();
	fcall	_pulse
	
l30000526:	
	line	42
;4 bit mode 4.c: 42: PORTD=(data&0X0F);
	movf	(data@data),w
	andlw	0Fh
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
...
; *************** function _pulse *****************
; Defined at:
;		line 21 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000517:	
	line	24
;4 bit mode 4.c: 24: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	25
;4 bit mode 4.c: 25: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 16 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode 4\4 bit mode 4.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
