...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\LCD\Custom\custom.c"
	line	9
...
; *************** function _main *****************
; Defined at:
;		line 54 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Custom\custom.c"
...
l30000557:	
;custom.c: 55: int i;
;custom.c: 56: TRISA=0X00; PORTA=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	57
;custom.c: 57: TRISB=0X00; PORTB=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	58
;custom.c: 58: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(7)	;volatile
	line	59
;custom.c: 59: TRISD=0X00; PORTD=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(8)	;volatile
	line	60
;custom.c: 60: TRISE=0X00; PORTE=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000558:	
	line	63
;custom.c: 63: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000559:	
	line	64
;custom.c: 64: command(0X38);
	movlw	(038h)
	fcall	_command
	
l30000560:	
	line	65
;custom.c: 65: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000561:	
	line	67
;custom.c: 67: command(0x40);
	movlw	(040h)
	fcall	_command
	
l30000562:	
	line	68
;custom.c: 68: for(i=0;i<7;i++)
	movlw	low(0)
	movwf	(main@i)
	movlw	high(0)
	movwf	((main@i))+1
...
l30000568:	
	line	73
;custom.c: 71: }
;custom.c: 73: command(0x48);
	movlw	(048h)
	fcall	_command
	
l30000569:	
	line	74
;custom.c: 74: for(i=0;i<7;i++)
	movlw	low(0)
	movwf	(main@i)
	movlw	high(0)
	movwf	((main@i))+1
...
l30000575:	
	line	79
;custom.c: 77: }
;custom.c: 79: command(0x50);
	movlw	(050h)
	fcall	_command
	
l30000576:	
	line	80
;custom.c: 80: for(i=0;i<7;i++)
	movlw	low(0)
	movwf	(main@i)
	movlw	high(0)
	movwf	((main@i))+1
...
l30000582:	
	line	85
;custom.c: 83: }
;custom.c: 85: command(0x58);
	movlw	(058h)
	fcall	_command
	
l30000583:	
	line	86
;custom.c: 86: for(i=0;i<7;i++)
	movlw	low(0)
	movwf	(main@i)
	movlw	high(0)
	movwf	((main@i))+1
...
l30000589:	
	line	100
;custom.c: 93: {
;custom.c: 100: command(0x81);
	movlw	(081h)
	fcall	_command
	line	101
;custom.c: 101: data(0x01);
	movlw	(01h)
	fcall	_data
	line	102
;custom.c: 102: delay(2000);
	movlw	low(07D0h)
	movwf	(?_delay)
	movlw	high(07D0h)
	movwf	((?_delay))+1
	fcall	_delay
	line	104
;custom.c: 104: command(0x82);
	movlw	(082h)
	fcall	_command
	line	105
;custom.c: 105: data(0x02);
	movlw	(02h)
	fcall	_data
	line	106
;custom.c: 106: delay(2000);
	movlw	low(07D0h)
	movwf	(?_delay)
	movlw	high(07D0h)
	movwf	((?_delay))+1
	fcall	_delay
	line	108
;custom.c: 108: command(0x83);
	movlw	(083h)
	fcall	_command
	line	109
;custom.c: 109: data(0x02);
	movlw	(02h)
	fcall	_data
	line	110
;custom.c: 110: delay(2000);
	movlw	low(07D0h)
	movwf	(?_delay)
	movlw	high(07D0h)
	movwf	((?_delay))+1
	fcall	_delay
	line	112
;custom.c: 112: command(0x84);
	movlw	(084h)
	fcall	_command
	line	113
;custom.c: 113: data(0x03);
	movlw	(03h)
	fcall	_data
	line	114
;custom.c: 114: delay(2000);
	movlw	low(07D0h)
	movwf	(?_delay)
	movlw	high(07D0h)
	movwf	((?_delay))+1
...
; *************** function _data *****************
; Defined at:
;		line 38 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Custom\custom.c"
; Parameters:    Size  Location     Type
...
;custom.c: 37: void data(char data)
;custom.c: 38: {
...
; *************** function _command *****************
; Defined at:
;		line 31 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Custom\custom.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;custom.c: 30: void command(char data)
;custom.c: 31: {
...
; *************** function _pulse *****************
; Defined at:
;		line 22 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Custom\custom.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
; *************** function _delay *****************
; Defined at:
;		line 17 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Custom\custom.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
