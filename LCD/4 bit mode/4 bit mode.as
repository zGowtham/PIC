...
z	equ	0
pclath	equ	10
# 2 "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
...
; *************** function _main *****************
; Defined at:
;		line 58 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
	line	58
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;4 bit mode.c: 57: void main()
;4 bit mode.c: 58: {
...
l30000532:	
;4 bit mode.c: 59: int i;
;4 bit mode.c: 61: TRISD=0X00; PORTD=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	62
;4 bit mode.c: 62: TRISE=0X00; PORTE=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(393)^0180h
	line	63
;4 bit mode.c: 63: TRISB=0X00; PORTB=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000533:	
	line	65
;4 bit mode.c: 65: command(0X02);
	movlw	(02h)
	fcall	_command
	
l30000534:	
	line	66
;4 bit mode.c: 66: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000535:	
	line	67
;4 bit mode.c: 67: command(0X28);
	movlw	(028h)
	fcall	_command
...
l30000536:	
	line	71
;4 bit mode.c: 70: {
;4 bit mode.c: 71: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000537:	
	line	72
;4 bit mode.c: 72: string("Gowtham");
	movlw	((STR_1-__stringbase))&0ffh
	fcall	_string
	
l30000538:	
	line	73
;4 bit mode.c: 73: command(0XC0);
	movlw	(0C0h)
	fcall	_command
	
l30000539:	
	line	74
;4 bit mode.c: 74: string("GOWTHAM");
...
; *************** function _string *****************
; Defined at:
;		line 49 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
; Parameters:    Size  Location     Type
...
;4 bit mode.c: 48: void string(char *ptr)
;4 bit mode.c: 49: {
...
; *************** function _command *****************
; Defined at:
;		line 31 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
; Parameters:    Size  Location     Type
...
;4 bit mode.c: 30: void command(char data)
;4 bit mode.c: 31: {
...
l30000519:	
	line	33
;4 bit mode.c: 33: PORTD=(data&0XF0);
	movf	(command@data),w
	andlw	0F0h
	movwf	(8)	;volatile
...
l30000520:	
	line	34
;4 bit mode.c: 34: pulse();
	fcall	_pulse
	
l30000521:	
	line	35
;4 bit mode.c: 35: PORTD=(data&0X0F)<<4;
	movf	(command@data),w
	andlw	0Fh
	movwf	(??_command+0+0)
	movlw	(04h)-1
...
; *************** function _data *****************
; Defined at:
;		line 40 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    3[COMMON] unsigned char 
...
;4 bit mode.c: 39: void data(char data)
;4 bit mode.c: 40: {
...
l30000524:	
	line	42
;4 bit mode.c: 42: PORTD=(data&0XF0);
	movf	(data@data),w
	andlw	0F0h
	movwf	(8)	;volatile
...
l30000525:	
	line	43
;4 bit mode.c: 43: pulse();
	fcall	_pulse
	
l30000526:	
	line	44
;4 bit mode.c: 44: PORTD=(data&0X0F)<<4;
	movf	(data@data),w
	andlw	0Fh
	movwf	(??_data+0+0)
	movlw	(04h)-1
...
; *************** function _pulse *****************
; Defined at:
;		line 23 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
l30000517:	
	line	26
;4 bit mode.c: 26: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	27
;4 bit mode.c: 27: delay(1000);
	movlw	low(03E8h)
	movwf	(?_delay)
	movlw	high(03E8h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 18 in file "C:\Users\gowth\Documents\PIC Programs\LCD\4 bit mode\4 bit mode.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
