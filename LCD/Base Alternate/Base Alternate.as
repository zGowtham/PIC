...
; *************** function _main *****************
; Defined at:
;		line 47 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
...
; 
psect	maintext
	file	"C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
	line	47
	global	__size_of_main
	__size_of_main	equ	__end_of_main-_main
;Base Alternate.c: 46: void main()
;Base Alternate.c: 47: {
...
l30000523:	
;Base Alternate.c: 48: TRISD=0X00; PORTD=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	49
;Base Alternate.c: 49: TRISE=0X00; PORTE=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000524:	
	line	50
;Base Alternate.c: 50: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	
l30000525:	
	line	51
;Base Alternate.c: 51: command(0X38);
	movlw	(038h)
	fcall	_command
...
l30000526:	
	line	55
;Base Alternate.c: 54: {
;Base Alternate.c: 55: command(0X80);
	movlw	(080h)
	fcall	_command
	
l30000527:	
	line	56
;Base Alternate.c: 56: string("Gowtham");
...
; *************** function _string *****************
; Defined at:
;		line 37 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
; Parameters:    Size  Location     Type
...
;Base Alternate.c: 36: void string(char *ptr)
;Base Alternate.c: 37: {
...
; *************** function _command *****************
; Defined at:
;		line 23 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
; Parameters:    Size  Location     Type
...
;Base Alternate.c: 22: void command(char data)
;Base Alternate.c: 23: {
...
l30000514:	
	line	25
;Base Alternate.c: 25: PORTD=data;
	movf	(command@data),w
	movwf	(8)	;volatile
	
l30000515:	
	line	26
;Base Alternate.c: 26: pulse();
	fcall	_pulse
...
; *************** function _data *****************
; Defined at:
;		line 30 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[COMMON] unsigned char 
...
;Base Alternate.c: 29: void data(char data)
;Base Alternate.c: 30: {
...
l30000517:	
	line	32
;Base Alternate.c: 32: PORTD=data;
	movf	(data@data),w
	movwf	(8)	;volatile
	
l30000518:	
	line	33
;Base Alternate.c: 33: pulse();
	fcall	_pulse
...
; *************** function _pulse *****************
; Defined at:
;		line 15 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
;Base Alternate.c: 14: void pulse()
;Base Alternate.c: 15: {
...
l30000512:	
	line	18
;Base Alternate.c: 18: RE1=0;
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	bcf	(73/8),(73)&7
	line	19
;Base Alternate.c: 19: delay(100);
	movlw	low(064h)
	movwf	(?_delay)
	movlw	high(064h)
	movwf	((?_delay))+1
...
; *************** function _delay *****************
; Defined at:
;		line 10 in file "C:\Users\gowth\Documents\PIC Programs\LCD\Base Alternate\Base Alternate.c"
; Parameters:    Size  Location     Type
;  x               2    0[COMMON] int 
; Auto vars:     Size  Location     Type
;		None
...
;Base Alternate.c: 9: void delay(int x)
;Base Alternate.c: 10: {
