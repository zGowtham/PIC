...
__pidataBANK0:
	file	"C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
	line	12
...
; *************** function _main *****************
; Defined at:
;		line 74 in file "C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
...
l30000689:	
;7 seg h.c: 75: TRISD=0X00; PORTD=0X00; ANSEL=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
	...
	movwf	(392)^0180h
	line	76
;7 seg h.c: 76: TRISE=0X00; PORTE=0X00; ANSELH=0;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000690:	
	line	77
;7 seg h.c: 77: TRISB=0X01; PORTB=0X00;
	movlw	(01h)
	bsf	status, 5	;RP0=1, select bank1
	bcf	status, 6	;RP1=0, select bank1
...
l30000692:	
	line	78
;7 seg h.c: 78: TRISA=0X00; PORTA=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000694:	
	line	79
;7 seg h.c: 79: TRISC=0X00; PORTC=0X00;
	clrc
	movlw	0
	btfsc	status,0
	movlw	1
...
l30000704:	
	line	94
;7 seg h.c: 93: {
;7 seg h.c: 94: _delay((unsigned long)((100)*(4000000/4000.0)));
	movlw	130
movwf	(??_main+0+0+1),f
	movlw	221
movwf	(??_main+0+0),f
...
; *************** function _intr *****************
; Defined at:
;		line 43 in file "C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
;7 seg h.c: 42: void interrupt intr()
;7 seg h.c: 43: {
...
i1l30000721:	
	line	47
;7 seg h.c: 45: {
;7 seg h.c: 47: command(0X0C);
	movlw	(0Ch)
	fcall	_command
	line	48
;7 seg h.c: 48: command(0X38);
	movlw	(038h)
	fcall	_command
	
i1l30000722:	
	line	50
;7 seg h.c: 50: for(i=count;i>=0;i--)
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_count+1),w
	clrf	(_i+1)
...
;7 seg h.c: 57: f=d%10;
	...
	line	59
;7 seg h.c: 59: command(0X80);
	movlw	(080h)
	fcall	_command
	line	60
;7 seg h.c: 60: data(a+48);
	bcf	status, 5	;RP0=0, select bank0
	bcf	status, 6	;RP1=0, select bank0
	movf	(_a),w
	addlw	030h
...
; *************** function _data *****************
; Defined at:
;		line 35 in file "C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
; Parameters:    Size  Location     Type
...
;7 seg h.c: 34: void data(char data)
;7 seg h.c: 35: {
...
; *************** function _command *****************
; Defined at:
;		line 28 in file "C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
; Parameters:    Size  Location     Type
;  data            1    wreg     unsigned char 
; Auto vars:     Size  Location     Type
;  data            1    2[BANK0 ] unsigned char 
...
;7 seg h.c: 27: void command(char data)
;7 seg h.c: 28: {
...
; *************** function _pulse *****************
; Defined at:
;		line 20 in file "C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
; Parameters:    Size  Location     Type
;		None
; Auto vars:     Size  Location     Type
;		None
...
; *************** function _delay *****************
; Defined at:
;		line 15 in file "C:\Users\gowth\Documents\PIC Programs\Interrupt\Basic\7Seg-LED Hardware\7Seg-LED H\7 seg h.c"
; Parameters:    Size  Location     Type
;  x               2    0[BANK0 ] int 
; Auto vars:     Size  Location     Type
;		None
...
;7 seg h.c: 11: static int count=0;
;7 seg h.c: 12: char number[]={0X3F,0X06,0X5B,0X4F,0X66,0X6D,0X7D,0X07,0X7F,0X67};
;7 seg h.c: 14: void delay(int x)
;7 seg h.c: 15: {
